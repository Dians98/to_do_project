...
function renderWeekTask(projects) {
  ...
  projects.forEach((project) => {
    ...
    const weekTask = tasks.filter((task) => {
      ...
      return (
        taskTimestamp >= lastSundayTimestamp &&
        taskTimestamp < nextSundayTimestamp
      );
    });
...
export function renderAllProjects(projects) {
  const to_do_projects_list_container = document.querySelector(
    ".to_do_projects_list_container"
  );
...
function viewTaskAddEventListener(viewTask, task) {
  viewTask.addEventListener("click", function () {
    ...
    taskModalElement.querySelector("#task_description").value =
      task.description;
    taskModalElement.querySelector("#task_description").disabled = true;

    taskModalElement.querySelector("#task_importance").checked =
      task.isImportant;
...
export function add_event_listener_on_add_project_modal_btn(
  AddProjectModalBtn,
  projects,
  ...
  AddProjectModalBtn.addEventListener("click", function () {
    ...
    if (name.trim() === "") {
      addProjectModal.querySelector(".project_name_error").style.display =
        "block";
      addProjectModal.querySelector(".project_name_error").textContent =
...
export function add_event_listener_on_add_task_modal_btn(
  addTaskModalBtn,
  projects,
  ...
  addTaskModalBtn.addEventListener("click", function () {
    ...
    const isImportant = addTaskModal.querySelector(
      "#add_task_importance"
    ).checked;
...
export function add_event_listener_on_submit_btn(
  submitBtn,
  projects,
  taskModalElement,
  taskModal
  ...
  submitBtn.addEventListener("click", function () {
    ...
    task.description =
      taskModalElement.querySelector("#task_description").value;
    task.isImportant = taskModalElement.querySelector("#task_importance")
      .checked
      ? true
      : false;
...
export function remove_all_active_menu() {
  document
    .querySelectorAll(".side_menu")
    .forEach((side_menu) => side_menu.classList.remove("active"));
}

export function add_event_listener_on_to_do_category(project) {
  document
    .querySelector(".to_do_categories")
...
export function add_event_listener_on_project_list(projects) {
  document
    .querySelector(".to_do_projects_list_container")
    .addEventListener("click", function (e) {
